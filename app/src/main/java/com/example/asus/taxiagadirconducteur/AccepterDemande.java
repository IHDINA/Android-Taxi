...
public class AccepterDemande extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accepter_demande);
        ...
        n=(TextView)findViewById(R.id.nom);
        p=(TextView)findViewById(R.id.prenom);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        Marker m1 = Map.addMarker(new MarkerOptions()
                ...
                .title("Client")
                .snippet("Snippet1")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.taxi_pos)));
